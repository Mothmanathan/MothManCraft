package com.Moth.MothmanCraft.armor;
...
public enum ModArmorMaterial  implements IArmorMaterial {
    // ruby_layer_1 ruby_layer2
    RUBY(Mothmancraft.MOD_ID + ":ruby", 25, new int[]{ 2, 5, 6 , 2}, 18,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F, () ->  {return  Ingredient.fromItems(RegistryHandler.RUBY.get());}, 1);
